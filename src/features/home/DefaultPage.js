  ...
  render() {
    ...
    return (
      <div className="home-default-page">
        ...
        <h1>Welcome to your Woola application!</h1>
        <p>
          Contratulations! You have created your Woola app successfully! Seeing this page means everything works well now.
        </p>
        <p>
          By default <a href="https://github.com/supnate/rekit">Woola Studio</a> is also started at <a href="http://localhost:6076">http://localhost:6076</a> to manage the project.
        </p>
        <p>
